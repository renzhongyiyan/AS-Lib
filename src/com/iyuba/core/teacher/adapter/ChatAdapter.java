...
public class ChatAdapter extends BaseExpandableListAdapter {
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		if(AccountManager.Instace(mContext).userId.equals(info.uid+"")
...
//			}
			...
			if(!AccountManager.Instace(mContext).userId.equals(info.uid+"")&&(AccountManager.Instace(mContext).isteacher.equals("1"))){
		...
		if(chat.type == 1) {
			...
			holder.otherContent.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					playVoice("http://www.iyuba.com/question/" + chat.content);// 播放
		...
		if (checkAgree("a"+info.answerid, AccountManager.Instace(mContext).userId) == 1) {
		...
		holder.agree.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				ExeProtocol.exe(new AgreeAgainstRequest(AccountManager.Instace(mContext).userId,AccountManager.Instace(mContext).userName,"answerid",""+info.answerid), new ProtocolResponse() {
				...
				new CommentAgreeOp(mContext).saveData(
						"a"+info.answerid, AccountManager.Instace(mContext).userId, "agree");
