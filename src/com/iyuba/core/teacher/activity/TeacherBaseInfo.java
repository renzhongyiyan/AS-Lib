...
public class TeacherBaseInfo extends Activity {
	...
	private TextView next2, editteachername, editteachermobile, editteacheremail, editteacherweixin, editteacherdesc, tvCheckState;
	...
	public void initData() {
		...
		if(teacher.flag.equals("0")){
			tvCheckState.setText("信息待完善");
		}else if(teacher.flag.equals("1")){
			tvCheckState.setText("审核中");
		}else if(teacher.flag.equals("2")){
			tvCheckState.setText("审核通过");
		}
	...
	public void initWidget() {
		...
		tvCheckState = (TextView) findViewById(R.id.checkstate);
