...
//		GitHubImageLoader.Instace(mContext).setCirclePic("http://api.iyuba.com.cn/v2/api.iyuba?protocol=10005&uid="+cp.uid, viewHolder.head, R.drawable.nearby_no_icon);
