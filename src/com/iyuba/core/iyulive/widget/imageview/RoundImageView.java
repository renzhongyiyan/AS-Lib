package com.iyuba.core.iyulive.widget.imageview;
...
public class RoundImageView extends ImageView {
    ...
    private void setCustomAttributes(AttributeSet attrs) {
        TypedArray a = RuntimeManager.getContext().obtainStyledAttributes(attrs,
                R.styleable.roundedimageview);
        radius = 0;
        mBorderThickness = a.getDimensionPixelSize(
                R.styleable.roundedimageview_border_thickness_num, 0);
        mBorderOutsideColor = a
                .getColor(R.styleable.roundedimageview_border_outside_color_rd,
                        defaultColor);
        mBorderInsideColor = a.getColor(
                R.styleable.roundedimageview_border_inside_color_rd, defaultColor);
