package com.iyuba.core.iyulive.lycam.ui;
...
public class SuperImageView extends ImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            borderColor = array.getColor(R.styleable.SuperImageView_super_border_color, borderColor);
            borderWidth = array.getDimensionPixelOffset(R.styleable.SuperImageView_super_border_width, borderWidth);
            pressAlpha = array.getInteger(R.styleable.SuperImageView_super_press_alpha, pressAlpha);
            pressColor = array.getColor(R.styleable.SuperImageView_super_press_color, pressColor);
            radius = array.getDimensionPixelOffset(R.styleable.SuperImageView_super_radius, radius);
            shapeType = array.getInteger(R.styleable.SuperImageView_super_shape_type, shapeType);
            array.recycle();
        }
