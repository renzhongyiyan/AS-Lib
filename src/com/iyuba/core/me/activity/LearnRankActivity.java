...
//    ImageButton titleButton;
    ...
    public void findViews(){
        ...
        rankUserWord = (TextView) findViewById(R.id.rank_user_total_word);
        rankUserTime = (TextView) findViewById(R.id.rank_user_total_time);

        myRankWord = (TextView) findViewById(R.id.rank_word_info);
        myRankTime = (TextView) findViewById(R.id.rank_time_info);

        rankListView = (ListView) findViewById(R.id.learn_rank_list);
...
//                        Toast.makeText(Main.this,"输入的是字母", Toast.LENGTH_SHORT).show();
                            ...
                            myRankWord.setText("累计阅读" + myTotalWord + "个单词");
                            myRankTime.setText("累计学习"+myTotalTime+"秒,当前排名:" + myRanking);

                            rankUserWord.setText("累计学习单词"+champion.getTotalWord()+"个");
                            rankUserTime.setText("累计学习时长"+champion.getTotalTime()+"秒");
                        } else {
